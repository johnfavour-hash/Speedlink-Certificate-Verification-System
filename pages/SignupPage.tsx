...
const SignupPage: React.FC<SignupPageProps> = ({ onNavigate }) => {
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 font-sans">
      ...
      <Header onNavigate={onNavigate} currentPage={Page.Signup} />
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 py-12 pt-24">
        <div className="w-full max-w-md">
            ...
            <div className="bg-white p-10 rounded-sm shadow-sm">
                ...
                <form onSubmit={(e) => { e.preventDefault(); onNavigate(Page.Login); }}>
                    <div className="mb-4">
                    <input
                ...
                <p className="text-center text-gray-600 text-xs">
                    ...
                    <button onClick={() => onNavigate(Page.Login)} className="font-bold text-[#3730a3] hover:underline">
                    Sign up
                    </button>
                </p>
            </div>
